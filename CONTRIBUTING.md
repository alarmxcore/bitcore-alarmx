...
These are some global design goals in bitcore-alarmx to which any change should adhere.
...
```sh
git remote add alarmx git@github.com:alarmxcore/bitcore-alarmx.git
git pull --rebase alarmx master
```
...
```
Finally go to [github.com/alarmxcore/bitcore-alarmx](https://github.com/alarmxcore/bitcore-alarmx) in your web browser and issue a new pull request.
...
[github.com/alarmxcore/bitcore-alarmx/issues](https://github.com/alarmxcore/bitcore-alarmx/issues).
