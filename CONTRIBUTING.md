# Contributing to Bitcore-GoByte

We're working hard to make *bitcore-gobyte* the most powerful JavaScript library for working with GoByte. Our goal is to have *bitcore-gobyte* be a library that can be used by anyone interested in GoByte, and to level expertise differences with great design and documentation.
...
These are some global design goals in bitcore-gobyte to which any change should adhere.
...
```sh
git remote add gobyte git@github.com:gobytecoin/bitcore-gobyte.git
git pull --rebase gobyte master
```
...
```
Finally go to [github.com/gobytecoin/bitcore-gobyte](https://github.com/gobytecoin/bitcore-gobyte) in your web browser and issue a new pull request.
...
[github.com/gobytecoin/bitcore-gobyte/issues](https://github.com/gobytecoin/bitcore-gobyte/issues).
